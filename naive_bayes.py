...
# SPECIFICATION: This program uses Naive Bayes to predict tennis playing based
# on weather data by training on one dataset and making predictions on another dataset.
# FOR: CS 4210- Assignment #2
# TIME SPENT: Took me the longer about 2 days spread out.
#-----------------------------------------------------------*/
