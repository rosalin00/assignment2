...
# SPECIFICATION: This program trains decision tree classifiers on different training datasets,
# converts categorical data to numerical form, and measures their accuracy on a test dataset, and then
# reports the lowest accuracy achieved for each training dataset.
# FOR: CS 4210- Assignment #2
# TIME SPENT: It took me about two days to complete this entire assignment.
#-----------------------------------------------------------*/
